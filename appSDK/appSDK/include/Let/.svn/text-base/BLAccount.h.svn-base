 ...
 * @param clientId cliendId
 * @param clientSecret clientSecret
 */
- (void)refreshAccessTokenWithRefreshToken:(NSString *_Nonnull)refreshToken clientId:(NSString *_Nonnull)clientId clientSecret:(NSString *_Nonnull)clientSecret completionHandler:(nullable void (^)(BLOauthResult * _Nonnull result))completionHandler;
