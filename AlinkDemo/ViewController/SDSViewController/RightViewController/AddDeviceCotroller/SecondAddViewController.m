...
//    UIButton *btn = [self.view viewWithTag:2567];
    if (self.Issecerity == YES) {
        ...
        [sender setBackgroundImage:[UIImage imageNamed:@"密码不可见"] forState:UIControlStateNormal];
    }else{
        [sender setBackgroundImage:[UIImage imageNamed:@"密码可见"] forState:UIControlStateNormal];
        self.Issecerity = YES;
